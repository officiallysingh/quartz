...
/**
 * <code>CalendarIntervalScheduleBuilder</code> is a {@link ScheduleBuilder} that defines calendar
...
public class CalendarIntervalScheduleBuilder extends ScheduleBuilder<CalendarIntervalTrigger> {
   ...
   * @param unit the time unit (IntervalUnit) of the interval. Cannot be less than
   *     IntervalUnit.SECOND .
  ...
  /**
   * If the Trigger misfires, use the {@link CalendarIntervalTrigger#MISFIRE_INSTRUCTION_DO_NOTHING}
   * instruction.
   *
   * @return the updated CalendarIntervalScheduleBuilder
   ...
   * @see TriggerBuilder#startAt(java.time.Instant)
   */
  public CalendarIntervalScheduleBuilder preserveHourOfDayAcrossDaylightSavings(
      boolean preserveHourOfDay) {
