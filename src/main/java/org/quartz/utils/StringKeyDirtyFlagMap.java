 ...
 *
 * <p>All allowsTransientData flag related methods are deprecated as of version 1.6.
 */
public class StringKeyDirtyFlagMap extends DirtyFlagMap<String, Object> {
  ...
  /**
   * @deprecated JDBCJobStores no longer prune out transient data. If you include non-Serializable
   *     values in the Map, you will now get an exception when attempting to store it in a database.
   */
  @Deprecated private boolean allowsTransientData = false;
  ...
  /**
   * Tell the <code>StringKeyDirtyFlagMap</code> that it should allow non-<code>Serializable</code>
  ...
  /**
   * Determine whether any values in this Map do not implement <code>Serializable</code>. Always
   * returns false if this Map is flagged to not allow transient data.
   *
   * @deprecated JDBCJobStores no longer prune out transient data. If you include non-Serializable
   *     values in the Map, you will now get an exception when attempting to store it in a database.
   */
  ...
  /**
   * Removes any data values in the map that are non-Serializable. Does nothing if this Map does not
   * allow transient data.
   *
   * @deprecated JDBCJobStores no longer prune out transient data. If you include non-Serializable
   *     values in the Map, you will now get an exception when attempting to store it in a database.
   */
