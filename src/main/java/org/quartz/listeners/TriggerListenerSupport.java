 ...
 * .
 *
 * <p>The methods in this class are empty so you only need to override the subset for the <code>
 * {@link org.quartz.TriggerListener}</code> events you care about.
 *
 * <p>You are required to implement <code>{@link org.quartz.TriggerListener#getName()}</code> to
 * return the unique name of your <code>TriggerListener</code>.
 *
