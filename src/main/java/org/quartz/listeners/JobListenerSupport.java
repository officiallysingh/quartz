 ...
 * {@link org.quartz.JobListener}</code> events you care about.
 *
 * <p>You are required to implement <code>{@link org.quartz.JobListener#getName()}</code> to return
 * the unique name of your <code>JobListener</code>.
 *
