 ...
 * {@link org.quartz.JobDetail}</code>,<code>{@link Trigger}</code> or <code>{@link Calendar}</code>
 * ) in a <code>{@link Scheduler}</code> failed, because one with the same name and group already
 * exists.
 *
 * @author James House
 */
