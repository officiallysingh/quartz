 ...
 * on a proper interface (ThreadPool, JobStore, etc). The motivation is to be tolerant of older
 * implementations that have not been updated for the changes in the interfaces (eg.
 * LocalTaskExecutorThreadPool in spring quartz helpers)
 *
 * @author teck
 */
