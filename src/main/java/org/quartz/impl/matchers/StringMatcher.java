...
public abstract class StringMatcher<T extends Key<?>> implements Matcher<T> {
  ...
  protected StringMatcher(String compareTo, StringOperatorName compareWith) {
    if (compareTo == null) throw new IllegalArgumentException("CompareTo value cannot be null!");
    if (compareWith == null)
  ...
  public boolean equals(Object obj) {
    ...
    if (compareTo == null) {
      if (other.compareTo != null) return false;
    } else if (!compareTo.equals(other.compareTo)) return false;
    if (compareWith == null) {
