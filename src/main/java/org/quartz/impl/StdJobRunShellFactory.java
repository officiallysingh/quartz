...
/**
 * Responsible for creating the instances of <code>{@link org.quartz.core.JobRunShell}</code> to be
 * used within the <code>{@link org.quartz.core.QuartzScheduler}</code> instance.
 *
 * @author James House
 */
public class StdJobRunShellFactory implements JobRunShellFactory {
   ...
   * <code>{@link org.quartz.core.JobRunShell}</code>.
   */
