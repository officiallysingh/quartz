...
public class WeeklyCalendar extends BaseCalendar implements Calendar, Serializable {
   ...
   * java.util.Calendar's constants like MONDAY should be used as index. A value of true is regarded
   * as: exclude it.
   */
   ...
   * java.util.Calendar's constants like MONDAY to determine the wday.
   */
