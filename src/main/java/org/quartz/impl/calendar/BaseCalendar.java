 ...
 *
 * <p>Regarded as base functionality is the treatment of base calendars. Base calendar allow you to
...
public class BaseCalendar implements Calendar, Serializable, Cloneable {
  ...
  /**
   * @param timeZone The time zone to use for this Calendar, <code>null</code> if <code>
   *     {@link TimeZone#getDefault()}</code> should be used
   */
  ...
  public Object clone() {
    try {
      ...
      if (getTimeZone() != null) clone.timeZone = (TimeZone) getTimeZone().clone();
      return clone;
   ...
   *
   * @return This Calendar's timezone, <code>null</code> if Calendar should use the <code>
   *     {@link TimeZone#getDefault()}</code>
   */
   ...
   * implementation of BaseCalendar simply calls the base calendars isTimeIncluded() method if base
   * calendar is set.
   *
  ...
  /**
   * Build a <code>{@link java.util.Calendar}</code> for the given timeStamp. The new Calendar will
   * use the <code>BaseCalendar</code> time zone if it is not <code>null</code>.
   */
  ...
  /**
   * Build a <code>{@link java.util.Calendar}</code> with the current time. The new Calendar will
   * use the <code>BaseCalendar</code> time zone if it is not <code>null</code>.
   */
   ...
   * calculation will take the <code>BaseCalendar</code> time zone into account if it is not <code>
   * null</code>.
   *
  ...
  /**
   * Returns the end of the given day <code>{@link java.util.Calendar}</code>. This calculation will
   * take the <code>BaseCalendar</code> time zone into account if it is not <code>null</code>.
   *
