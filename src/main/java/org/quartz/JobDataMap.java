 ...
 * scheduler. They are also re-persisted after every execution of jobs annotated with <code>
 * @PersistJobDataAfterExecution</code>.
 *
 ...
 *
 * <p>Update since 2.2.4 - We keep an dirty flag for this map so that whenever you
 * modify(add/delete) any of the entries, it will set to "true". However if you create new instance
 * using an existing map with {@link #JobDataMap(Map)}, then the dirty flag will NOT be set to
 * "true" until you modify the instance.
 *
 * @see Job
...
public class JobDataMap extends StringKeyDirtyFlagMap implements Serializable {
  ...
  public JobDataMap(Map<?, ?> map) {
    this();
    @SuppressWarnings(
        "unchecked") // casting to keep API compatible and avoid compiler errors/warnings.
    Map<String, Object> mapTyped = (Map<String, Object>) map;
    putAll(mapTyped);

    // When constructing a new data map from another existing map, we should NOT mark dirty flag as
    // true
  ...
  /**
   * Adds the given <code>boolean</code> value as a string version to the <code>Job</code>'s data
   * map.
   */
  ...
  /**
   * Adds the given <code>char</code> value as a string version to the <code>Job</code>'s data map.
   */
  ...
  /**
   * Adds the given <code>Character</code> value as a string version to the <code>Job</code>'s data
   * map.
   */
  ...
  /**
   * Adds the given <code>double</code> value as a string version to the <code>Job</code>'s data
   * map.
   */
  ...
  /**
   * Adds the given <code>float</code> value as a string version to the <code>Job</code>'s data map.
   */
  ...
  /**
   * Adds the given <code>int</code> value as a string version to the <code>Job</code>'s data map.
   */
  ...
  /**
   * Adds the given <code>Integer</code> value as a string version to the <code>Job</code>'s data
   * map.
   */
  ...
  /**
   * Adds the given <code>long</code> value as a string version to the <code>Job</code>'s data map.
   */
