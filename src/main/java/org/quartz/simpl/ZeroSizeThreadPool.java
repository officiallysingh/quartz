 ...
 * {@link org.quartz.spi.ThreadPool}</code> interface.
 *
 * <p>The pool has zero <code>Thread</code>s and does not grow or shrink based on demand. Which
 * means it is obviously not useful for most scenarios. When it may be useful is to prevent creating
 * any worker threads at all - which may be desirable for the sole purpose of preserving system
