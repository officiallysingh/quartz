 ...
 * {@link #SYSTEM_PROPERTY}, but can be specified via the "systemPropertyName" property.
 *
 * <p>You can also set the properties "postpend" and "prepend" to String values that will be added
 * to the beginning or end (respectively) of the value found in the system property.
 *
 * <p>If no value set for the property, a {@link org.quartz.SchedulerException} is thrown
 *
 * @author Alex Snaps
 */
public class SystemPropertyInstanceIdGenerator implements InstanceIdGenerator {
   ...
   *
   * <p>Defaults to {@link #SYSTEM_PROPERTY}.
   */
  ...
  public void setSystemPropertyName(String systemPropertyName) {
    this.systemPropertyName =
        systemPropertyName == null ? SYSTEM_PROPERTY : systemPropertyName.trim();
  }
}
