...
/**
 * <code>SimpleScheduleBuilder</code> is a {@link ScheduleBuilder} that defines strict/literal
...
public class SimpleScheduleBuilder extends ScheduleBuilder<SimpleTrigger> {
   ...
   * interval.
   *
   * <p>Note: Total count = 1 (at start time) + repeat count
   *
   * @return the new SimpleScheduleBuilder
   */
  ...
  /**
   * Specify the number of times the trigger will repeat - the total number of firings will be this
   * number + 1.
   *
   * @param triggerRepeatCount the number of times the trigger should repeat after the initial
   *     firing.
   * @return the updated SimpleScheduleBuilder
