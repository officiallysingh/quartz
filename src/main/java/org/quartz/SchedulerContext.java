 ...
 *
 * <p>Future versions of Quartz may make distinctions on how it propagates data in <code>
 * SchedulerContext</code> between instances of proxies to a single scheduler instance - i.e. if
 * Quartz is being used via RMI.
 *
