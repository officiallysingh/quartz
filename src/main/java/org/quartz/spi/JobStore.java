...
/**
 * The interface to be implemented by classes that want to provide a <code>{@link org.quartz.Job}
 * </code> and <code>{@link org.quartz.Trigger}</code> storage mechanism for the <code>
 * {@link org.quartz.core.QuartzScheduler}</code>'s use.
 *
...
public interface JobStore {
  ...
  /**
   * Called by the QuartzScheduler to inform the <code>JobStore</code> that the scheduler has
   * started.
   */
  void schedulerStarted() throws SchedulerException;

  /**
   * Called by the QuartzScheduler to inform the <code>JobStore</code> that the scheduler has been
   * paused.
   */
  ...
  /**
   * Store the given <code>{@link org.quartz.JobDetail}</code> and <code>{@link org.quartz.Trigger}
   * </code>.
   *
   ...
   *     JobStore</code> with the same name and group should be over-written.
   * @throws ObjectAlreadyExistsException if a <code>Job</code> with the same name/group already
  ...
  /**
   * Remove (delete) the <code>{@link org.quartz.Job}</code> with the given key, and any <code>
   * {@link org.quartz.Trigger}</code> s that reference it.
   *
   ...
   *
   * @return <code>true</code> if a <code>Job</code> with the given name and group was found and
  ...
  /**
   * Retrieve the <code>{@link org.quartz.JobDetail}</code> for the given <code>
   * {@link org.quartz.Job}</code>.
   *
   ...
   */
  List<JobDetail> getJobDetails(GroupMatcher<JobKey> matcher) throws JobPersistenceException;
   ...
   *
   * @return <code>true</code> if a <code>Trigger</code> with the given name and group was found and
   *     removed from the store.
   */
   ...
   * @param replaceExisting If <code>true</code>, any <code>Calendar</code> existing in the <code>
   *     JobStore</code> with the same name and group should be over-written.
   * @param updateTriggers If <code>true</code>, any <code>Trigger</code>s existing in the <code>
   *     JobStore</code> that reference an existing Calendar with the same name with have their next
   *     fire time re-computed with the new <code>Calendar</code>.
   ...
   * nonexistent calendars, then a <code>JobPersistenceException</code> will be thrown. *
   *
  ...
  /**
   * Get the number of <code>{@link org.quartz.Job}</code> s that are stored in the <code>JobsStore
   * </code>.
   */
  int getNumberOfJobs() throws JobPersistenceException;

  /**
   * Get the number of <code>{@link org.quartz.Trigger}</code> s that are stored in the <code>
   * JobsStore</code>.
   */
  int getNumberOfTriggers() throws JobPersistenceException;

  /**
   * Get the number of <code>{@link org.quartz.Calendar}</code> s that are stored in the <code>
   * JobsStore</code>.
   */
  int getNumberOfCalendars() throws JobPersistenceException;

  /**
   * Get the keys of all of the <code>{@link org.quartz.Job}</code> s that have the given group
   * name.
   *
   * <p>If there are no jobs in the given group name, the result should be an empty collection (not
   * <code>null</code>).
   */
  Set<JobKey> getJobKeys(GroupMatcher<JobKey> matcher) throws JobPersistenceException;

  /**
   * Get the names of all of the <code>{@link org.quartz.Trigger}</code> s that have the given group
   * name.
   *
   * <p>If there are no triggers in the given group name, the result should be a zero-length array
   * (not <code>null</code>).
   */
   ...
   *
   * <p>If there are no known group names, the result should be a zero-length array (not <code>null
   * </code>).
   */
  ...
  /**
   * Get the names of all of the <code>{@link org.quartz.Calendar}</code> s in the <code>JobStore
   * </code>.
   *
   * <p>If there are no Calendars in the given group name, the result should be a zero-length array
   * (not <code>null</code>).
   */
   ...
   */
  default List<OperableTrigger> getTriggersByJobGroup(GroupMatcher<JobKey> matcher)
      throws JobPersistenceException {
   ...
   * @see #getTriggersByJobAndTriggerGroup(GroupMatcher, GroupMatcher)
   */
  default List<OperableTrigger> getTriggersByTriggerGroup(GroupMatcher<TriggerKey> matcher)
      throws JobPersistenceException {
    return getTriggersByJobAndTriggerGroup(GroupMatcher.anyGroup(), matcher);
  }

  /**
   * Get all the Triggers that are associated with the Job &amp; trigger group matcher <br>
   ...
   * @see #getTriggersByTriggerGroup(GroupMatcher)
   */
  List<OperableTrigger> getTriggersByJobAndTriggerGroup(
   ...
   *
   * <p>The JobStore should "remember" that the group is paused, and impose the pause on any new
   * triggers that are added to the group while the group is paused.
   *
  ...
  /**
   * Pause the <code>{@link org.quartz.Job}</code> with the given name - by pausing all of its
  ...
  /**
   * Pause all of the <code>{@link org.quartz.Job}s</code> in the given group - by pausing all of
   * their <code>Trigger</code>s.
   *
   * <p>The JobStore should "remember" that the group is paused, and impose the pause on any new
   * jobs that are added to the group while the group is paused.
   *
   ...
   * (reserved).
   *
   * @return may return null if all the triggers or their calendars no longer exist, or if the
   *     trigger was not successfully put into the 'executing' state. Preference is to return an
   *     empty list if none of the triggers could be fired.
   */
   ...
   * <code>Trigger</code> (and the execution of its associated <code>Job</code> completed, threw an
   * exception, or was vetoed), and that the <code>{@link org.quartz.JobDataMap}</code> in the given
  ...
  /**
   * Inform the <code>JobStore</code> of the Scheduler instance's Id, prior to initialize being
   * invoked.
   *
   * @since 1.7
   */
  ...
  /**
   * Inform the <code>JobStore</code> of the Scheduler instance's name, prior to initialize being
   * invoked.
   *
   * @since 1.7
   */
