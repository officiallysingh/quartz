 ...
 *
 * <p>If you use <code>{@link org.quartz.impl.StdSchedulerFactory}</code> to initialize your
 * Scheduler, it can also create and initialize your plugins - look at the configuration docs for
 * details.
 *
