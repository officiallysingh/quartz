 ...
 * The <code>{@link JobListener}</code> interface provides notifications of <code>Job</code>
 ...
 *
 * <p>Listener registration order is preserved, and hence notification of listeners will be in the
...
public interface ListenerManager {
  ...
  /**
   * Add the given <code>{@link JobListener}</code> to the <code>Scheduler</code>, and register it
   * to receive events for all Jobs.
   *
   * <p>Because no matchers are provided, the <code>EverythingMatcher</code> will be used.
   *
   * @see Matcher
  ...
  /**
   * Add the given <code>{@link JobListener}</code> to the <code>Scheduler</code>, and register it
   * to receive events for Jobs that are matched by the given Matcher.
   *
   * <p>If no matchers are provided, the <code>EverythingMatcher</code> will be used.
   *
   * @see Matcher
   * @see org.quartz.impl.matchers.EverythingMatcher
   */
  ...
  /**
   * Add the given <code>{@link JobListener}</code> to the <code>Scheduler</code>, and register it
   * to receive events for Jobs that are matched by ANY of the given Matchers.
   *
   * <p>If no matchers are provided, the <code>EverythingMatcher</code> will be used.
   *
   * @see Matcher
   ...
   * match.
   *
   * <p>Removes any existing matchers for the identified listener!
   *
   * @param listenerName the name of the listener to add the matcher to
  ...
  /**
   * Get a List containing all of the <code>{@link JobListener}</code>s in the <code>Scheduler
   * </code>, in the order in which they were registered.
   */
  ...
  /**
   * Add the given <code>{@link TriggerListener}</code> to the <code>Scheduler</code>, and register
   * it to receive events for all Triggers.
   *
   * <p>Because no matcher is provided, the <code>EverythingMatcher</code> will be used.
   *
   * @see Matcher
   * @see org.quartz.impl.matchers.EverythingMatcher
   */
  ...
  /**
   * Add the given <code>{@link TriggerListener}</code> to the <code>Scheduler</code>, and register
   * it to receive events for Triggers that are matched by the given Matcher.
   *
   * <p>If no matcher is provided, the <code>EverythingMatcher</code> will be used.
   *
   * @see Matcher
   * @see org.quartz.impl.matchers.EverythingMatcher
   */
  ...
  /**
   * Add the given <code>{@link TriggerListener}</code> to the <code>Scheduler</code>, and register
   * it to receive events for Triggers that are matched by ANY of the given Matchers.
   *
   * <p>If no matcher is provided, the <code>EverythingMatcher</code> will be used.
   *
   * @see Matcher
  ...
  /**
   * Get a List containing all of the <code>{@link TriggerListener}</code>s in the <code>Scheduler
   * </code>, in the order in which they were registered.
   */
  ...
  /** Register the given <code>{@link SchedulerListener}</code> with the <code>Scheduler</code>. */
  void addSchedulerListener(SchedulerListener schedulerListener);

  /**
   * Remove the given <code>{@link SchedulerListener}</code> from the <code>Scheduler</code>.
   *
   * @return true if the identified listener was found in the list, and removed.
   */
  ...
  /**
   * Get a List containing all of the <code>{@link SchedulerListener}</code>s registered with the
