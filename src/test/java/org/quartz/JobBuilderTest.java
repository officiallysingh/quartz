...
public class JobBuilderTest {
  ...
  void testJobBuilder() throws Exception {
    ...
    assertEquals(
        ...
        job.getKey().getGroup(),
        "Unexpected job group: " + job.getKey().getGroup());
    ...
    assertFalse(
        job.isConcurrentExecutionDisallowed(),
        "Expected isConcurrentExecutionDisallowed == false ");
    assertFalse(
        job.isPersistJobDataAfterExecution(), "Expected isPersistJobDataAfterExecution == false ");
    ...
    assertEquals(
        "my description",
        job.getDescription(),
        "Unexpected job description: " + job.getDescription());
    assertTrue(job.isDurable(), "Expected isDurable == true ");
    assertTrue(job.requestsRecovery(), "Expected requestsRecovery == true ");
    assertTrue(
        job.isConcurrentExecutionDisallowed(), "Expected isConcurrentExecutionDisallowed == true ");
    assertTrue(
        job.isPersistJobDataAfterExecution(), "Expected isPersistJobDataAfterExecution == true ");
